...
<head>
  ...
  <title>IIIT Vadodara E-Election Portal</title>
  <!-- GOOGLE WEB FONT -->
...
<body class="text-center">
      <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <header class="masthead mb-auto">
            <div class="inner">
                <h3 style="text-align: center;">E-Election-Portal</h3>
            </div>
        </header>

        <main role="main" class="inner cover">
        <h1 class="cover-heading">IIIT Vadodara</h1>
        <p class="lead">Welcome to IIIT Vadodara's E-Election Portal<br>
